...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ATTACKSWING,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleAttackSwingOpcode         ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_HELLO,                           STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode        ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_ITEM,                          STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleAutoEquipItemOpcode       ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BANKER_ACTIVATE,                         STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleBankerActivateOpcode      ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUY_BANK_SLOT,                           STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleBuyBankSlotOpcode         ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_AURA,                             STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleCancelAuraOpcode          ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_CAST,                             STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleCancelCastOpcode          ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_TRADE,                            STATUS_UNHANDLED_OR_RECENTLY_LOGGOUT,    PROCESS_THREADUNSAFE,    &WorldSession::HandleCancelTradeOpcode);
    DEFINE_OPCODE_HANDLER(CMSG_CAST_SPELL,                              STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleCastSpellOpcode           ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CREATE,                             STATUS_UNHANDLED,       PROCESS_THREADUNSAFE, &WorldSession::HandleCharCreateOpcode          ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CUSTOMIZE,                          STATUS_UNHANDLED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCustomize             );
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_DELETE,                             STATUS_UNHANDLED,       PROCESS_THREADUNSAFE, &WorldSession::HandleCharDeleteOpcode          ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_ENUM,                               STATUS_UNHANDLED,       PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode            ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CREATURE_QUERY,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleCreatureQueryOpcode       ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DESTROY_ITEM,                            STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleDestroyItemOpcode         ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJECT_QUERY,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleGameObjectQueryOpcode     ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_HELLO,                            STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleGossipHelloOpcode         ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_SELECT_OPTION,                    STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleGossipSelectOptionOpcode  ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_JOIN_CHANNEL,                            STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleJoinChannel               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LIST_INVENTORY,                          STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleListInventoryOpcode       ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_LOAD_SCREEN,                             STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleLoadScreenOpcode          ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_LOGOUT_CANCEL,                           STATUS_UNHANDLED,    PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutCancelOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_LOGOUT_REQUEST,                          STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutRequestOpcode       ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_GUILD,                       STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_SAY,                         STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_WHISPER,                     STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_YELL,                        STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NAME_QUERY,                              STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleNameQueryOpcode           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_REALM_NAME_QUERY,                        STATUS_UNHANDLED,     PROCESS_THREADSAFE, &WorldSession::HandleRealmNameQueryOpcode        ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NPC_TEXT_QUERY,                          STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleNpcTextQueryOpcode        ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_OBJECT_UPDATE_FAILED,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleObjectUpdateFailedOpcode  ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPENING_CINEMATIC,                       STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleOpeningCinematic          ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_NAME_QUERY,                          STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandlePetNameQuery              ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PLAYED_TIME,                             STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandlePlayedTime                ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_PLAYER_LOGIN,                            STATUS_UNHANDLED,       PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerLoginOpcode         ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_RANDOMIZE_CHAR_NAME,                     STATUS_UNHANDLED,       PROCESS_THREADUNSAFE, &WorldSession::HandleRandomizeCharNameOpcode   ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(CMSG_READY_FOR_ACCOUNT_DATA_TIMES,            STATUS_UNHANDLED,       PROCESS_THREADUNSAFE, &WorldSession::HandleReadyForAccountDataTimes  ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REPAIR_ITEM,                             STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleRepairItemOpcode          ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_HOTFIX,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleRequestHotfix             ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SETSHEATHED,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleSetSheathedOpcode         ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_ACTION_BUTTON,                       STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionButtonOpcode     ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_SELECTION,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleSetSelectionOpcode        ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SPLIT_ITEM,                              STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleSplitItemOpcode           ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_ITEM,                               STATUS_UNHANDLED,     PROCESS_THREADUNSAFE, &WorldSession::HandleSwapItem                  ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TIME_SYNC_RESP,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleTimeSyncResp              ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_VIOLENCE_LEVEL,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleViolenceLevel             ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WORLD_STATE_UI_TIMER_UPDATE,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::HandleWorldStateUITimerUpdate   ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_FALL_LAND,                           STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_HEARTBEAT,                           STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_JUMP,                                STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_FACING,                          STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_PITCH,                           STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_BACKWARD,                      STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_DESCEND,                       STATUS_UNHANDLED,    PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_FORWARD,                       STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,                   STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,                  STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_SWIM,                          STATUS_UNHANDLED,    PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_TURN_LEFT,                     STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_TURN_RIGHT,                    STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP,                                STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_STRAFE,                         STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM,                           STATUS_UNHANDLED,    PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_TURN,                           STATUS_UNHANDLED,     PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACCOUNT_DATA_TIMES,                      STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACTION_BUTTONS,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ALL_ACHIEVEMENT_DATA,                    STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_HELLO,                           STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AURA_UPDATE,                             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_CHALLENGE,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_RESPONSE,                           STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHANNEL_NOTIFY,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_LOGIN_FAILED,                  STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CREATE,                             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CUSTOMIZE,                          STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_DELETE,                             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_ENUM,                               STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENTCACHE_VERSION,                     STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CREATURE_QUERY_RESPONSE,                 STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DB_REPLY,                                STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DESTROY_OBJECT,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_QUERY_RESPONSE,               STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_MESSAGE,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_POI,                              STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INITIAL_SPELLS,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INVENTORY_CHANGE_FAILURE,                STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                           STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_LEVELUP_INFO,                            STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LIST_INVENTORY,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_LOAD_CUF_PROFILES,                       STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_SETTIMESPEED,                      STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_VERIFY_WORLD,                      STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_CANCEL_ACK,                       STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_COMPLETE,                         STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_RESPONSE,                         STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_LOG_XPGAIN,                              STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MESSAGECHAT,                             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOTD,                                    STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_FLY,                        STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_FLIGHT_SPEED,                   STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_RUN_SPEED,                      STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_SWIM_BACK_SPEED,                STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_SWIM_SPEED,                     STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_TURN_RATE,                      STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_WALK_SPEED,                     STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNROOT,                             STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_FLY,                      STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NAME_QUERY_RESPONSE,                     STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_REALM_NAME_QUERY_RESPONSE,               STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_NEW_TAXI_PATH,                           STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD,                               STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NPC_TEXT_UPDATE,                         STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_NAME_QUERY_RESPONSE,                 STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYED_TIME,                             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_MOVE,                             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RANDOMIZE_CHAR_NAME,                     STATUS_UNHANDLED,        PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SHOW_BANK,                               STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TIME_SYNC_REQ,                           STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRIGGER_CINEMATIC,                       STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TUTORIAL_FLAGS,                          STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                           STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_SERVER_INFO,                       STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_STATE_UI_TIMER_UPDATE,             STATUS_UNHANDLED,        PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // 5.4.2 17688
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_ACTIVE_PVP_CHEAT,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_ADD_PVP_MEDAL_CHEAT,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_ADVANCE_SPAWN_TIME,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AFK_MONITOR_INFO_CLEAR,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AFK_MONITOR_INFO_REQUEST,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AUTH_SRP6_BEGIN,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AUTH_SRP6_PROOF,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AUTH_SRP6_RECODE,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_GROUND_ITEM,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_GROUND_ITEM,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_JOIN,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MANAGER_ADVANCE_STATE,       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MANAGER_SET_NEXT_TRANSITION_TIME, STATUS_UNHANDLED, PROCESS_INPLACE,     &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_REQUEST_SCORE_DATA,          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     ); Need to send the response
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_BEASTMASTER,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BOOTME,                                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BOT_DETECTED,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BOT_DETECTED2,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BUY_ITEM_IN_SLOT,                        STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyItemInSlotOpcode       );
  //DEFINE_OPCODE_HANDLER(CMSG_BUY_LOTTERY_TICKET_OBSOLETE,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_BUY_STABLE_SLOT,                         STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyStableSlot             );
  //DEFINE_OPCODE_HANDLER(CMSG_CALENDAR_CONTEXT_EVENT_SIGNUP,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CALENDAR_EVENT_INVITE_NOTES,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_CHANGE_GDF_ARENA_RATING,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHANGE_PERSONAL_ARENA_RATING,            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHARACTER_POINT_CHEAT,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHEAT_PLAYER_LOGIN,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHEAT_PLAYER_LOOKUP,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHEAT_SETMONEY,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHEAT_SET_ARENA_CURRENCY,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHEAT_SET_HONOR_CURRENCY,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CHECK_LOGIN_CRITERIA,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CLEAR_EXPLORATION,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CLEAR_HOLIDAY_BG_WIN_TIME,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CLEAR_QUEST,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CLEAR_RANDOM_BG_WIN_TIME,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CLEAR_SERVER_BUCK_DATA,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_ACHIEVEMENT_CHEAT,              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CONTROLLER_EJECT_PASSENGER,              STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleEjectPassenger            );
  //DEFINE_OPCODE_HANDLER(CMSG_COOLDOWN_CHEAT,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CREATEGAMEOBJECT,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CREATEITEM,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_CREATEMONSTER,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DBLOOKUP,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_ACTIONS_START,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_ACTIONS_STOP,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_AISTATE,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_CHANGECELLZONE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_LIST_TARGETS,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_PASSIVE_AURA,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEBUG_SERVER_GEO,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DECHARGE,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DECLINE_CHANNEL_INVITE,                  STATUS_UNHANDLED,  PROCESS_INPLACE,      &WorldSession::HandleChannelDeclineInvite      );
  //DEFINE_OPCODE_HANDLER(CMSG_DELETE_DANCE,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DEL_PVP_MEDAL_CHEAT,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DESTROYMONSTER,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DESTROY_ITEMS,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DISABLE_PVP_CHEAT,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DROP_NEW_CONNECTION,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_DUMP_OBJECTS,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_ENABLE_DAMAGE_LOG,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_END_BATTLEFIELD_CHEAT,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_EXPIRE_RAID_INSTANCE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FLAG_QUEST,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FLAG_QUEST_FINISH,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FLOOD_GRACE_CHEAT,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FORCEACTION,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FORCEACTIONONOTHER,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FORCEACTIONSHOW,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FORCE_ANIM,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_FORCE_SAY_CHEAT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GAMESPEED_SET,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GAMETIME_SET,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GETDEATHBINDZONE,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GET_CHANNEL_MEMBER_COUNT,                STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetChannelMemberCount     );
  //DEFINE_OPCODE_HANDLER(CMSG_GHOST,                                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GMRESPONSE_CREATE_TICKET,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_CHARACTER_RESTORE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_CHARACTER_SAVE,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_CREATE_ITEM_TARGET,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_DESTROY_ONLINE_CORPSE,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_FREEZE,                               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_GRANT_ACHIEVEMENT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_INVIS,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_MOVECORPSE,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_NUKE,                                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_NUKE_ACCOUNT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_NUKE_CHARACTER,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_REMOVE_ACHIEVEMENT,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_REQUEST_PLAYER_INFO,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_RESURRECT,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_REVEALTO,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_SET_CRITERIA_FOR_PLAYER,              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_SET_SECURITY_GROUP,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_SHOW_COMPLAINTS,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_SILENCE,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_SUMMONMOB,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_TEACH,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_UBERINVIS,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_UNSQUELCH,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_UNTEACH,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_UPDATE_TICKET_STATUS,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_VISION,                               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GM_WHISPER,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GODMODE,                                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GROUP_CANCEL,                            STATUS_UNHANDLED,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GROUP_UNINVITE,                          STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupUninviteOpcode       );
  //DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_NOTE,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_GUILD_CREATE,                            STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildCreateOpcode         );
  //DEFINE_OPCODE_HANDLER(CMSG_GUILD_INFO,                              STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildInfoOpcode           );
  //DEFINE_OPCODE_HANDLER(CMSG_IGNORE_DIMINISHING_RETURNS_CHEAT,        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_IGNORE_KNOCKBACK_CHEAT,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_IGNORE_REQUIREMENTS_CHEAT,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_INSTANCE_LOCK_RESPONSE,                  STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleInstanceLockResponse      );
  //DEFINE_OPCODE_HANDLER(CMSG_LEARN_DANCE_MOVE,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LEARN_SPELL,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LEVEL_CHEAT,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LFG_SET_NEEDS,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LF_GUILD_JOIN,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LOAD_DANCES,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LOTTERY_QUERY_OBSOLETE,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_LUA_USAGE,                               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MAELSTROM_GM_SENT_MAIL,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MAELSTROM_INVALIDATE_CACHE,              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MAELSTROM_RENAME_GUILD,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MAKEMONSTERATTACKGUID,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MEETINGSTONE_INFO,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_CHARACTER_CHEAT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_CHARM_PORT_CHEAT,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_CHARM_TELEPORT_CHEAT,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_ENABLE_SWIM_TO_FLY_TRANS_ACK,       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_RELATIVE_POSITION,              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_VEHICLE_REC_ID_ACK,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_START_SWIM_CHEAT,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_MOVE_STOP_SWIM_CHEAT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_NEW_SPELL_SLOT,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_NO_SPELL_VARIANCE,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PERFORM_ACTION_SET,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PETGODMODE,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PET_LEVEL_CHEAT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PET_NAME_CACHE,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PET_UNLEARN,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PET_UNLEARN_TALENTS,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PLAYER_AI_CHEAT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PLAYER_DIFFICULTY_CHANGE,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PLAYER_LOGOUT,                           STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerLogoutOpcode        );
  //DEFINE_OPCODE_HANDLER(CMSG_PROFILEDATA_REQUEST,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_PVP_QUEUE_STATS_REQUEST,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_MAX_XP,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_QUERY_OBJECT_POSITION,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_QUERY_OBJECT_ROTATION,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_QUERY_SERVER_BUCK_DATA,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_QUERY_VEHICLE_STATUS,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_CANCEL,                       STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverCancel          );
  //DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_QUEST_AUTOLAUNCH,             STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQuestAutoLaunch );
  //DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_SWAP_QUEST,                     STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogSwapQuest         );
  //DEFINE_OPCODE_HANDLER(CMSG_RECHARGE,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_REDIRECTION_FAILED,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_REFER_A_FRIEND,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_REMOVE_GLYPH,                            STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleRemoveGlyph               );
  //DEFINE_OPCODE_HANDLER(CMSG_REPLACE_ACCOUNT_DATA,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_RUN_SCRIPT,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SAVE_DANCE,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SAVE_PLAYER,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SEARCH_LFG_JOIN,                         STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfrJoinOpcode           );
  //DEFINE_OPCODE_HANDLER(CMSG_SEARCH_LFG_LEAVE,                        STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfrLeaveOpcode            );
  //DEFINE_OPCODE_HANDLER(CMSG_SEND_COMBAT_TRIGGER,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SEND_EVENT,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SEND_GENERAL_TRIGGER,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SEND_LOCAL_EVENT,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SERVERINFO,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SERVERTIME,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SERVER_BROADCAST,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SERVER_COMMAND,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SERVER_INFO_QUERY,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SETDEATHBINDPOINT,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_ACTIVE_TALENT_GROUP_OBSOLETE,        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_ARENA_MEMBER_SEASON_GAMES,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_ARENA_MEMBER_WEEKLY_GAMES,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_ARENA_TEAM_RATING_BY_INDEX,          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_ARENA_TEAM_SEASON_GAMES,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_ARENA_TEAM_WEEKLY_GAMES,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_BREATH,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_CHARACTER_MODEL,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_CRITERIA_CHEAT,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_DURABILITY_CHEAT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_EXPLORATION,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_EXPLORATION_ALL,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_FACTION_CHEAT,                       STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetFactionCheat           );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_GLYPH,                               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_GLYPH_SLOT,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_GRANTABLE_LEVELS,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_LFG_COMMENT,                         STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetCommentOpcode       );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_PAID_SERVICE_CHEAT,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_PVP_RANK_CHEAT,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_PVP_TITLE,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_RUNE_COOLDOWN,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_RUNE_COUNT,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_SKILL_CHEAT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_STAT_CHEAT,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_TITLE_SUFFIX,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SET_WORLDSTATE,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SKILL_BUY_RANK,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SKILL_BUY_STEP,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_STABLE_PET,                              STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleStablePet                 );
  //DEFINE_OPCODE_HANDLER(CMSG_STABLE_REVIVE_PET,                       STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleStableRevivePet           );
  //DEFINE_OPCODE_HANDLER(CMSG_STABLE_SWAP_PET,                         STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleStableSwapPet             );
  //DEFINE_OPCODE_HANDLER(CMSG_START_BATTLEFIELD_CHEAT,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_START_QUEST,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_STORE_LOOT_IN_SLOT,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_SUSPEND_COMMS_ACK,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TARGET_CAST,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TARGET_SCRIPT_CAST,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXICLEARALLNODES,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXICLEARNODE,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXIENABLEALLNODES,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXIENABLENODE,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXISHOWNODES,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TEST_DROP_RATE,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_XP_GAIN,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TRIGGER_CINEMATIC_CHEAT,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNCLAIM_LICENSE,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNDRESSPLAYER,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNITANIMTIER_CHEAT,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_DANCE_MOVE,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SPELL,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_TALENTS,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNSTABLE_PET,                            STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnstablePet               );
  //DEFINE_OPCODE_HANDLER(CMSG_UNUSED5,                                 STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_UNUSED6,                                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_USE_SKILL_CHEAT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_VOICE_SET_TALKER_MUTED_REQUEST,          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_WEATHER_SPEED_CHEAT,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_XP_CHEAT,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_ZONE_MAP,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_DELAY_GHOST_TELEPORT,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_DEV_SHOWLABEL,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_ACCOUNT_ONLINE,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_BIND_OTHER,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_CHANGE_ARENA_RATING,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_DESTROY_CORPSE,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_GEARRATING,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_RESETINSTANCELIMIT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_SHOWLABEL,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_GM_SUMMON,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_ALL_SPEED_CHEAT,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_FLIGHT_BACK_SPEED_CHEAT,         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_FLIGHT_SPEED_CHEAT,              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_PITCH_RATE_CHEAT,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RAW_POSITION_ACK,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT,            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RUN_SPEED_CHEAT,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_SWIM_SPEED_CHEAT,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_TURN_RATE_CHEAT,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_WALK_SPEED_CHEAT,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_START_SWIM_CHEAT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM_CHEAT,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_TOGGLE_FALL_LOGGING,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_MOVE_TOGGLE_LOGGING,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_NULL_ACTION,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(MSG_PVP_LOG_DATA,                             STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandlePVPLogDataOpcode          );
  //DEFINE_OPCODE_HANDLER(MSG_VIEW_PHASE_SHIFT,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(SMSG_AFK_MONITOR_INFO_RESPONSE,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_AURACASTLOG,                             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  ...
  //DEFINE_OPCODE_HANDLER(SMSG_CALENDAR_ACTION_PENDING,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CALENDAR_UPDATE_INVITE_LIST,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHANGEPLAYER_DIFFICULTY_RESULT,          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_PROFILE,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_PROFILE_REALM_CONNECTED,       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY_RESPONSE,    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY_RESPONSE_WRITE_FILE, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHEAT_PLAYER_LOOKUP,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CHECK_FOR_BOTS,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CLEAR_EXTRA_AURA_INFO_OBSOLETE,          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_COMBAT_LOG_MULTIPLE,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_COMMENTATOR_GET_PLAYER_INFO,             STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_COMPLETION_NPC_RESPONCE,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_CORPSE_IS_NOT_IN_INSTANCE,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DAMAGE_DONE_OBSOLETE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DBLOOKUP,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DEBUGAURAPROC,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DEBUG_AISTATE,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DEBUG_LIST_TARGETS,                      STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DEBUG_SERVER_GEO,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DUMP_OBJECTS_DATA,                       STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_DYNAMIC_DROP_ROLL_RESULT,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  ...
  //DEFINE_OPCODE_HANDLER(SMSG_FORCE_DISPLAY_UPDATE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GAMETIMEBIAS_SET,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GHOSTEE_GONE,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GMRESPONSE_CREATE_TICKET,                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GOGOGO_OBSOLETE,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GUILD_CANCEL,                            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GUILD_INFO,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GUILD_KNOWN_RECIPES,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GUILD_SET_NOTE,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GUILD_TRADESKILL_UPDATE,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_GUILD_XP_UPDATE,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT,        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_IGNORE_REQUIREMENTS_CHEAT,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_INIT_EXTRA_AURA_INFO_OBSOLETE,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_INSPECT,                                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_JOINED_BATTLEGROUND_QUEUE,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  ...
  //DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_SEARCH_RESULT,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_LOTTERY_QUERY_RESULT_OBSOLETE,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_LOTTERY_RESULT_OBSOLETE,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MEETINGSTONE_MEMBER_ADDED,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MEETINGSTONE_SETQUEUE,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MINIGAME_MOVE_FAILED,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MOVE_CHARACTER_CHEAT,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_VEHICLE_REC_ID,                 STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_WALK_IN_AIR,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MOVE_SKIP_TIME,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_WALK_IN_AIR,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_NPC_WONT_TALK,                           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_PET_UNLEARN_CONFIRM,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_PLAYER_UNK_DEAD_ALIVE,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_PROFILEDATA_RESPONSE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_PUREMOUNT_CANCELLED_OBSOLETE,            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_PVP_QUEUE_STATS,                         STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_QUERY_OBJECT_POSITION,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_QUERY_OBJECT_ROTATION,                   STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_RAID_READY_CHECK_ERROR,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_REMOVED_FROM_PVP_QUEUE,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_RESET_RANGED_COMBAT_TIMER,               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_RESISTLOG,                               STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  ...
  //DEFINE_OPCODE_HANDLER(SMSG_SCRIPT_MESSAGE,                          STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_SEND_ALL_COMBAT_LOG,                     STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_SERVERINFO,                              STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_SERVER_BUCK_DATA,                        STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_SERVER_BUCK_DATA_START,                  STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE_OBSOLETE, STATUS_UNHANDLED,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_SET_EXTRA_AURA_INFO_OBSOLETE,            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  ...
  //DEFINE_OPCODE_HANDLER(SMSG_SPELL_CHANCE_RESIST_PUSHBACK,            STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_VOICE_SESSION_ADJUST_PRIORITY,           STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_VOICE_SESSION_ENABLE,                    STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  //DEFINE_OPCODE_HANDLER(SMSG_ZONE_MAP,                                STATUS_UNHANDLED,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
